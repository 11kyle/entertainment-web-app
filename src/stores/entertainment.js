...
export const useEntertainmentStore = defineStore("entertainment", {
  state: () => ({
    /** @type {{ title: string, thumbnail: object, year: number, category: string, rating: string, isBookmarked: boolean, isTrending: boolean }[]} */
    entertainment: [
      {
        title: "Beyond Earth",
        thumbnail: {
  ...
  getters: {
    movies() {
      return this.entertainment.filter((item) => item.category === "Movie")
    },
    tvSeries() {
      return this.entertainment.filter((item) => item.category === "TV Series")
    },
    bookmarkedEntertainment() {
      return this.entertainment.filter((item) => item.isBookmarked)
    },
    trendingEntertainment() {
      return this.entertainment.filter((item) => item.isTrending)
    },
    /**
    ...
    filteredEntertainment() {
      if (this.filter === "Movie") {
        ...
        return this.movies
      } else if (this.filter === "TV Series") {
        return this.tvSeries
      } else if (this.filter === "isBookmarked") {
        return this.bookmarkedEntertainment
      } else {
